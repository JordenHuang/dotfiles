-- Resotre the last use floating client geometry (width / height / position)
-- (for example after swapping from tiling mode to floating mode)

-- Thanks to gitarrik for sharing to the reddit r/awesomewm (https://www.reddit.com/r/awesomewm/comments/cn02m6/floating_clients_restore_position_after_layout/)
-- (source code) https://gist.github.com/gitaarik/c28511f0a7a94a2b23d6b64a306584c9
