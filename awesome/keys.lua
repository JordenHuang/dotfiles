...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey }, "u", function()
        ...
        { description = "jump to urgent client, or go back to last tag", group = "client" }),
    awful.key({ user_keys.alt,           }, "Tab",
        function ()
...
clientbuttons = gears.table.join(
    ...
    -- For laptap touchpad resizing window
    awful.button({ modkey, user_keys.alt }, 1, function (c)
        c:emit_signal("request::activate", "mouse_click", {raise = true})
        awful.mouse.client.resize(c)
    end)
)
